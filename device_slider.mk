DEVICE_PACKAGE_OVERLAYS += device/lge/slider/overlay/common device/lge/slider/overlay/$(SUB_MODEL)

ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := device/lge/slider/files/kernel/$(SUB_MODEL)/zImage
else
...
# Backlight
PRODUCT_COPY_FILES += \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/lib/hw/lights.msm7k.so:system/lib/hw/lights.msm7k.so \
...
# Keylayouts
PRODUCT_COPY_FILES += \
    device/lge/slider/files/usr/keylayout/7k_handset.kl:system/usr/keylayout/7k_handset.kl \
    device/lge/slider/files/usr/keylayout/AVRCP.kl:system/usr/keylayout/AVRCP.kl \
    device/lge/slider/files/usr/keylayout/Broadcom_Bluetooth_HID.kl:system/usr/keylayout/Broadcom_Bluetooth_HID.kl \
    device/lge/slider/files/usr/keylayout/gelato_keypad.kl:system/usr/keylayout/gelato_keypad.kl \
    device/lge/slider/files/usr/keylayout/qwerty.kl:system/usr/keylayout/qwerty.kl \
...
PRODUCT_COPY_FILES += \
    device/lge/slider/files/init.thunderc.rc:root/init.thunderc.rc \
    device/lge/slider/files/ueventd.thunderc.rc:root/ueventd.thunder.rc \
    device/lge/slider/files/initlogo.rle:root/initlogo.rle \
    device/lge/slider/files/chargerlogo:root/chargerlogo \
    device/lge/slider/files/chargerimages/battery_ani_01.rle:root/chargerimages/battery_ani_01.rle \
    device/lge/slider/files/chargerimages/battery_ani_02.rle:root/chargerimages/battery_ani_02.rle \
    device/lge/slider/files/chargerimages/battery_ani_03.rle:root/chargerimages/battery_ani_03.rle \
    device/lge/slider/files/chargerimages/battery_ani_04.rle:root/chargerimages/battery_ani_04.rle \
    device/lge/slider/files/chargerimages/battery_ani_05.rle:root/chargerimages/battery_ani_05.rle \
    device/lge/slider/files/chargerimages/battery_charging_01.rle:root/chargerimages/battery_charging_01.rle \
    device/lge/slider/files/chargerimages/battery_charging_02.rle:root/chargerimages/battery_charging_02.rle \
    device/lge/slider/files/chargerimages/battery_charging_03.rle:root/chargerimages/battery_charging_03.rle \
    device/lge/slider/files/chargerimages/battery_charging_04.rle:root/chargerimages/battery_charging_04.rle \
    device/lge/slider/files/chargerimages/battery_charging_05.rle:root/chargerimages/battery_charging_05.rle \
    device/lge/slider/files/chargerimages/battery_charging_06.rle:root/chargerimages/battery_charging_06.rle \
    device/lge/slider/files/chargerimages/battery_notenough.rle:root/chargerimages/battery_notenough.rle \
    device/lge/slider/files/chargerimages/battery_bg.rle:root/chargerimages/battery_bg.rle \
    device/lge/slider/files/chargerimages/black_bg.rle:root/chargerimages/black_bg.rle \
    device/lge/slider/files/chargerimages/battery_wait_ani_01.rle:root/chargerimages/battery_wait_ani_01.rle \
    device/lge/slider/files/chargerimages/battery_wait_ani_01.rle:root/chargerimages/battery_wait_ani_02.rle \
    device/lge/slider/files/etc/init.local.rc:/system/etc/init.local.rc
...
PRODUCT_COPY_FILES += \
    ...
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/lib/hw/gralloc.msm7k.so:system/lib/hw/gralloc.msm7k.so \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/lib/hw/copybit.msm7k.so:system/lib/hw/copybit.msm7k.so \

# Sensors
PRODUCT_COPY_FILES += \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/lib/hw/sensors.lge_gelato.so:system/lib/hw/sensors.lge_gelato.so \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/bin/ami304d:system/bin/ami304d \

# GPS
PRODUCT_COPY_FILES += \
    device/lge/slider/files/etc/loc_parameter.ini:system/etc/loc_parameter.ini \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/lib/libloc_api-rpc-qc.so:system/lib/libloc_api-rpc-qc.so \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/lib/libgps.so:system/lib/libgps.so \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/lib/libloc_ext.so:system/lib/libloc_ext.so \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/lib/libloc_ext.so:obj/lib/libloc_ext.so \
...
# WiFi
PRODUCT_COPY_FILES += \
    device/lge/slider/files/kernel/$(SUB_MODEL)/libra.ko:system/lib/modules/libra.ko \
    device/lge/slider/files/kernel/$(SUB_MODEL)/librasdioif.ko:system/lib/modules/librasdioif.ko \
    device/lge/slider/files/kernel/$(SUB_MODEL)/wireless.ko:system/lib/modules/wireless.ko \
    device/lge/slider/files/etc/wifi/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf \
    device/lge/slider/files/etc/dhcpcd/dhcpcd.conf:system/etc/dhcpcd/dhcpcd.conf \
...
# Audio
PRODUCT_COPY_FILES += \
    device/lge/slider/files/etc/AudioFilter.csv:system/etc/AudioFilter.csv \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/lib/libaudioeq.so:system/lib/libaudioeq.so \
    device/lge/slider/files/etc/AutoVolumeControl.txt:system/etc/AutoVolumeControl.txt \
...
PRODUCT_COPY_FILES += \
    ...
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/lib/libdl.so:system/lib/libdl.so \
...
PRODUCT_COPY_FILES += \
    device/lge/slider/files/etc/media_profiles.xml:system/etc/media_profiles.xml \
    device/lge/slider/files/etc/init.d/mvdalvik.sh:system/etc/init.d/01mvdalvik \

# Apps
PRODUCT_COPY_FILES += \
    device/lge/slider/files/apps/CarHomeGoogle.apk:system/app/CarHomeGoogle.apk \
    device/lge/slider/files/apps/LauncherPro.apk:system/app/LauncherPro.apk \

# Let's use our own GPS config file
PRODUCT_COPY_FILES += device/lge/slider/files/etc/gps.conf:system/etc/gps.conf
...
# Bluetooth
PRODUCT_COPY_FILES += \
    vendor/lge/thunderc/proprietary/$(SUB_MODEL)/system/bin/$(BLUETOOTH_FIRMWARE):system/bin/BCM4330.hcd
